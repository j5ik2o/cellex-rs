...
pub trait ActorRuntime: Clone {
  ...
  ///
  /// Note: On platforms without atomic pointer support (`target_has_atomic = "ptr"`),
  /// the returned closure does not implement `Send + Sync`.
  ...
  /// Returns a factory function for creating synchronous mutexes.
  ///
  /// The returned factory is a shared Rc-wrapped closure that can be cloned
  /// to create runtime-appropriate mutex instances.
  ///
  /// Note: On platforms without atomic pointer support (`target_has_atomic = "ptr"`),
  /// the returned closure does not implement `Send + Sync`.
  ...
  ///
  /// The returned factory is a shared Rc-wrapped closure that can be cloned
  /// to create runtime-appropriate async mutex instances.
  ///
  /// Note: On platforms without atomic pointer support (`target_has_atomic = "ptr"`),
  /// the returned closure does not implement `Send + Sync`.
  #[cfg(not(target_has_atomic = "ptr"))]
