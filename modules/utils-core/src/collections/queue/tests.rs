...
use crate::{
  ...
  sync::{sync_mutex_like::SpinSyncMutex, ArcShared, SharedError},
};
...
mod fifo_backend {
  ...
  use crate::collections::queue::backend::{OfferOutcome, OverflowPolicy, QueueError, SyncQueueBackend};
...
mod priority_backend {
  ...
  use super::QueueConfig;
  use crate::collections::queue::backend::{
