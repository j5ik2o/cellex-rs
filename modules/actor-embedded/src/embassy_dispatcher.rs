...
///   pub fn dispatcher(system: GenericActorSystem<u32, LocalMailboxFactory>)
/// );
///
/// fn start(spawner: &Spawner, system: &'static mut GenericActorSystem<u32, LocalMailboxFactory>) {
