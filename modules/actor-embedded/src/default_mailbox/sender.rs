...
where
  M: Element,
  RM: RawMutex, {
  pub(crate) inner: QueueMailboxProducer<SystemMailboxQueue<M>, UserMailboxQueue<M>, DefaultSignal<RM>>,
}
  ...
  RM: RawMutex,
{
  ...
  pub fn inner(&self) -> &QueueMailboxProducer<SystemMailboxQueue<M>, UserMailboxQueue<M>, DefaultSignal<RM>> {
    &self.inner
  }
